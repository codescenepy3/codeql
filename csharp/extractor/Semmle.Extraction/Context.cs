...
namespace Semmle.Extraction
{
    ...
    public class Context
    {
        ...
        /// Creates a new entity using the factory.
        ///
        /// Unlike `CreateNullableEntity` and `CreateNonNullEntity`, entities are cached
        /// based the entity itself instead of the initializer `init`, which means that
        /// `init` can also possibly be `null`.
        /// </summary>
        /// <param name="factory">The entity factory.</param>
        /// <param name="init">The initializer for the entity.</param>
        /// <returns>The new/existing entity.</returns>
